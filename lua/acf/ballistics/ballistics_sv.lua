...
function Ballistics.DoBulletsFlight(Bullet)
	...
	FlightTr.start 	= Bullet.Pos - (Bullet.Pos - Bullet.LastPos) * (Bullet.Iterations >= 1 and 1 or 0) -- Compensate for high velocity and low tickrate by extending the trace backwards
	...
	-- Debug.Cross(FlightTr.start, 8, 30, Bullet.Color, true)
