...
local function CreateMenu(Menu)
	...
	Settings:AddTitle("Car Steering Settings")
	Settings:AddLabel("Brake Strength is interpreted as the car's steer angle in degrees (this should be within 0 to 45).")
