...
local function CreateMenu(Menu)
	...
	local Overview = Menu:AddCollapsible("Overview", true)
	Overview:AddLabel("ACF AIO Controllers allow you to easilly setup a tank without using wiremod")

	local Instructions = Menu:AddCollapsible("Instructions", true)
	...
	local Settings = Menu:AddCollapsible("Settings Instructions", true)
	Settings:AddLabel("Some defaults are applied when you place a controller with the tool. You can change these by editting its properties using the context menu (C + right click).")
