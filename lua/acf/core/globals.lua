...
do -- ACF global vars
	...
	ACF.AutoloaderWorstDistVertical = 75 -- Vertical distance after which autoloaders are least effective
	...
	ACF.InitReloadDelay		= 1		-- Delay after spawning that belt feds are loaded
