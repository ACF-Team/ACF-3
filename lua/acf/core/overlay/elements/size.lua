...
function ELEMENT.Render(_, Slot)
    ...
    local W2, H2 = Overlay.GetTextSize(Overlay.MAIN_FONT, GetVectorStringFromSlot(Slot))
...
function ELEMENT.PostRender(_, Slot)
    ...
    Overlay.SimpleText(GetVectorStringFromSlot(Slot), Overlay.MAIN_FONT, Overlay.GetKVValueX(), 0, Overlay.COLOR_TEXT, TEXT_ALIGN_RIGHT, TEXT_ALIGN_TOP)
end
