...
do
	...
	FuelTanks.RegisterItem("Tank_6x6x2","FTS_6", {
	...
	FuelTanks.RegisterItem("Tank_6x6x4","FTS_6", {
	...
	FuelTanks.RegisterItem("Tank_6x8x1","FTS_6", {
	...
	FuelTanks.RegisterItem("Tank_6x8x2","FTS_6", {
	...
	FuelTanks.RegisterItem("Tank_6x8x4","FTS_6", {
