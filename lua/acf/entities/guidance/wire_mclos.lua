...
Classes.DefineClass("ACF.Missiles.Guidance.WireMCLOS", "ACF.Missiles.Guidance.RadioMCLOS", function(CLASS, BASE)
	...
	if CLIENT then
		...
		function CLASS:OnRange(Missile)
		...
		function CLASS:SnapRope(Missile)
