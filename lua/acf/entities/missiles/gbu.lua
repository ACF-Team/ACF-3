...
Classes.DefineClass("ACF.Missiles.GuidedBomb", "ACF.Missiles.BaseMissile", function(CLASS)
	...
	CLASS.NoThrust		= true
	CLASS.Spread		= 1
	CLASS.Blacklist		= { ["ACF.Ammunition.AP"] = true, ["ACF.Ammunition.APHE"] = true, ["ACF.Ammunition.HP"] = true, ["ACF.Ammunition.FL"] = true }
	CLASS.LimitConVar	= {
		Name = "_acfm_gbu",
		Amount = 8,
...
Classes.DefineClass("ACF.Missiles.GuidedBomb.Walleye", "ACF.Missiles.GuidedBomb", function(CLASS)
	...
	CLASS.Guidances		= { ["ACF.Missiles.Guidance.Dumb"] = true, ["ACF.Missiles.Guidance.RadioMCLOS"] = true }
