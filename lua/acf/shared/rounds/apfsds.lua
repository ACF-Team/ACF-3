...
function Round.convert(_, PlayerData)
	...
	Data.ProjMass = (Data.FrArea / 22) * (Data.ProjLength * 7.9 / 1000) --Volume of the projectile as a cylinder * density of steel
	Data.ShovePower = 0.2
	Data.PenArea = (Data.FrArea ^ ACF.PenAreaMod) / 8.5
	Data.DragCoef = ((Data.FrArea / 60000) / Data.ProjMass)
...
ACF.RoundTypes.APFSDS = Round --Set the round properties