...
function Ammo:Network(Crate, BulletData)
	Crate:SetNW2String("AmmoType", "HEAT")
	...
	Crate:SetNW2Float("SlugMass", BulletData.SlugMass)
	Crate:SetNW2Float("SlugCaliber", BulletData.SlugCaliber)
	Crate:SetNW2Float("SlugDragCoef", BulletData.SlugDragCoef)
