...
ACF_DefineEngine( "3.6-V6", {
	...
	sound = "acf_engines/v6_petrolsmall.mp3",
	category = "V6",
	fuel = "Petrol",
...
ACF_DefineEngine( "6.2-V6", {
	...
	sound = "acf_engines/v6_petrolmedium.mp3",
	category = "V6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 360,
...
ACF_DefineEngine( "5.2-V6", {
	...
	model = "models/engines/v6med.mdl",
	sound = "acf_engines/i5_dieselmedium.mp3",
	category = "V6",
	fuel = "Multifuel",
...
ACF_DefineEngine( "12.0-V6", {
	...
	sound = "acf_engines/v6_petrollarge.mp3",
	category = "V6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 675,
...
ACF_DefineEngine( "15.0-V6", {
	...
	model = "models/engines/v6large.mdl",
	sound = "acf_engines/v6_diesellarge.mp3",
	category = "V6",
	fuel = "Multifuel",
	enginetype = "GenericDiesel",
	weight = 900,
