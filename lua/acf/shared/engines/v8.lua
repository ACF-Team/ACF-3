...
ACF_DefineEngine( "5.7-V8", {
	...
	sound = "acf_engines/v8_petrolsmall.mp3",
	category = "V8",
	fuel = "Petrol",
...
ACF_DefineEngine( "9.0-V8", {
	...
	sound = "acf_engines/v8_petrolmedium.mp3",
	category = "V8",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 400,
...
ACF_DefineEngine( "18.0-V8", {
	...
	sound = "acf_engines/v8_petrollarge.mp3",
	category = "V8",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 850,
...
ACF_DefineEngine( "4.5-V8", {
	...
	model = "models/engines/v8s.mdl",
	sound = "acf_engines/v8_dieselsmall.mp3",
	category = "V8",
	fuel = "Diesel",
...
ACF_DefineEngine( "7.8-V8", {
	...
	model = "models/engines/v8m.mdl",
	sound = "acf_engines/v8_dieselmedium2.mp3",
	category = "V8",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 520,
...
ACF_DefineEngine( "19.0-V8", {
	...
	model = "models/engines/v8l.mdl",
	sound = "acf_engines/v8_diesellarge.mp3",
	category = "V8",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 1200,
