...
ACF_DefineEngine( "2.2-I6", {
	...
	sound = "acf_engines/l6_petrolsmall2.mp3",
	category = "I6",
	fuel = "Petrol",
...
ACF_DefineEngine( "4.8-I6", {
	...
	sound = "acf_engines/l6_petrolmedium.mp3",
	category = "I6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 300,
...
ACF_DefineEngine( "17.2-I6", {
	...
	sound = "acf_engines/l6_petrollarge2.mp3",
	category = "I6",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 850,
...
ACF_DefineEngine( "3.0-I6", {
	...
	model = "models/engines/inline6s.mdl",
	sound = "acf_engines/l6_dieselsmall.mp3",
	category = "I6",
	fuel = "Diesel",
...
ACF_DefineEngine( "6.5-I6", {
	...
	model = "models/engines/inline6m.mdl",
	sound = "acf_engines/l6_dieselmedium4.mp3",
	category = "I6",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 450,
...
ACF_DefineEngine( "20.0-I6", {
	...
	model = "models/engines/inline6l.mdl",
	sound = "acf_engines/l6_diesellarge2.mp3",
	category = "I6",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 1200,
