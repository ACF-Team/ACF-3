...
ACF_DefineEngine( "4.6-V12", {
	...
	sound = "acf_engines/v12_petrolsmall.mp3",
	category = "V12",
	fuel = "Petrol",
...
ACF_DefineEngine( "7.0-V12", {
	...
	sound = "acf_engines/v12_petrolmedium.mp3",
	category = "V12",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 360,
...
ACF_DefineEngine( "23.0-V12", {
	...
	sound = "acf_engines/v12_petrollarge.mp3",
	category = "V12",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 1350,
...
ACF_DefineEngine( "4.0-V12", {
	...
	model = "models/engines/v12s.mdl",
	sound = "acf_engines/v12_dieselsmall.mp3",
	category = "V12",
	fuel = "Diesel",
...
ACF_DefineEngine( "9.2-V12", {
	...
	model = "models/engines/v12m.mdl",
	sound = "acf_engines/v12_dieselmedium.mp3",
	category = "V12",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 600,
...
ACF_DefineEngine( "21.0-V12", {
	...
	model = "models/engines/v12l.mdl",
	sound = "acf_engines/v12_diesellarge.mp3",
	category = "V12",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 1800,
...
ACF_DefineEngine( "13.0-V12", {
	...
	model = "models/engines/v12m.mdl",
	sound = "acf_engines/v12_special.mp3",
	category = "V12",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 520,
