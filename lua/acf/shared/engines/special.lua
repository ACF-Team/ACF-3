...
ACF_DefineEngine( "0.9L-I2", {
	...
	sound = "acf_extra/vehiclefx/engines/ponyengine.mp3",
	category = "Special",
	fuel = "Petrol",
...
ACF_DefineEngine( "1.0L-I4", {
	...
	sound = "acf_extra/vehiclefx/engines/l4/mini_onhigh.mp3",
	pitch = 0.75,
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
...
ACF_DefineEngine( "1.8L-V4", {
	...
	sound = "acf_extra/vehiclefx/engines/l4/elan_onlow.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "2.4L-V6", {
	...
	sound = "acf_extra/vehiclefx/engines/l6/capri_onmid.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "1.9L-I4", {
	...
	model = "models/engines/inline4s.mdl",
	sound = "acf_engines/i4_special.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "2.6L-Wankel", {
	...
	sound = "acf_engines/wankel_large.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "Wankel",
	requiresfuel = true,
...
ACF_DefineEngine( "2.9-V8", {
	...
	sound = "acf_engines/v8_special.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "3.8-I6", {
	...
	sound = "acf_engines/l6_special.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "5.3-V10", {
	...
	sound = "acf_engines/v10_special.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 300,
...
ACF_DefineEngine( "7.2-V8", {
	...
	sound = "acf_engines/v8_special2.mp3",
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	requiresfuel = true,
...
ACF_DefineEngine( "3.0-V12", {
	...
	sound = "acf_extra/vehiclefx/engines/v12/gtb4_onmid.mp3",
	pitch = 0.85,
	category = "Special",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
