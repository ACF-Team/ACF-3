...
ACF_DefineEngine( "1.2-I3", {
	...
	sound = "acf_engines/i4_petrolsmall2.mp3",
	category = "I3",
	fuel = "Petrol",
...
ACF_DefineEngine( "3.4-I3", {
	...
	sound = "acf_engines/i4_petrolmedium2.mp3",
	category = "I3",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 170,
...
ACF_DefineEngine( "13.5-I3", {
	...
	sound = "acf_engines/i4_petrollarge.mp3",
	category = "I3",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 500,
...
ACF_DefineEngine( "1.1-I3", {
	...
	model = "models/engines/inline3s.mdl",
	sound = "acf_engines/i4_diesel2.mp3",
	category = "I3",
	fuel = "Diesel",
...
ACF_DefineEngine( "2.8-I3", {
	...
	model = "models/engines/inline3m.mdl",
	sound = "acf_engines/i4_dieselmedium.mp3",
	category = "I3",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 200,
...
ACF_DefineEngine( "11.0-I3", {
	...
	model = "models/engines/inline3b.mdl",
	sound = "acf_engines/i4_diesellarge.mp3",
	category = "I3",
	fuel = "Diesel",
	enginetype = "GenericDiesel",
	weight = 650,
