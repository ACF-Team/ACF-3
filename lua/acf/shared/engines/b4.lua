...
ACF_DefineEngine( "1.4-B4", {
	...
	sound = "acf_engines/b4_petrolsmall.mp3",
	category = "B4",
	fuel = "Petrol",
...
ACF_DefineEngine( "2.1-B4", {
	...
	model = "models/engines/b4small.mdl",
	sound = "acf_engines/b4_petrolmedium.mp3",
	category = "B4",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 125,
...
ACF_DefineEngine( "3.2-B4", {
	...
	sound = "acf_engines/b4_petrollarge.mp3",
	category = "B4",
	fuel = "Petrol",
	enginetype = "GenericPetrol",
	weight = 210,
...
ACF_DefineEngine( "2.4-B4", {
	...
	model = "models/engines/b4small.mdl",
	sound = "acf_extra/vehiclefx/engines/coh/ba11.mp3",
	category = "B4",
	fuel = "Multifuel",
