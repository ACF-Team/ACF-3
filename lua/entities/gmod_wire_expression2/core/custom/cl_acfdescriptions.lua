...
E2Desc["acfConvexHealth(e:n)"] = "Returns the current health of a specific convex of an entity."
E2Desc["acfConvexHealthMax(e:n)"] = "Returns the max health of a specific convex of an entity."
E2Desc["acfConvexHealthPercent(e:n)"] = "Returns the health percentage of a specific convex of an entity."
E2Desc["acfConvexCount(e:)"] = "Returns the number of convexes of an entity."
E2Desc["acfConvexMaterial(e:n)"] = "Returns the material of a specific convex of an entity."
E2Desc["acfConvexMaterials(e:)"] = "Returns the materials of all convexes of an entity, indexed by convex ID."
...
E2Desc["acfMaxTorqueWithFuel(e:)"] = "Deprecated. Returns the maximum torque (in N/m) of an ACF entity. Use e:acfMaxTorque() instead."
E2Desc["acfMaxPowerWithFuel(e:)"] = "Deprecated. Returns the maximum power (in kW) of an ACF entity. Use e:acfMaxPower() instead."
...
E2Desc["acfMagSize(e:)"] = "Returns the magazine capacity of an ACF entity, or its currently available rounds if it has no magazine (belt feds, single-shot)."
E2Desc["acfMagReloadTime(e:)"] = "Returns time it takes for an ACF entity to reload a magazine, or 0 if it has no magazine."
