    ...
    hook.Add( "HUDPaintBackground", "ACFAddonControllerHUD", function()
        ...
        elseif HudType == 1 or HudType == 2 then
            ...
            elseif HudType == 2 then
                DrawRect( x + 2.025 * Scale, y - 0.5 * Scale, 12.825 * Scale, Scale )
                DrawRect( x - 14.85 * Scale, y - 0.5 * Scale, 12.825 * Scale, Scale )
                DrawRect( x - 0.5 * Scale, y + 2.025 * Scale, Scale, 12.825 * Scale )
                DrawRect( x - 0.5 * Scale, y - 14.85 * Scale, Scale, 12.825 * Scale )

                DrawRect( x + 27.3375 * Scale, y - 0.5 * Scale, 26.325 * Scale, Scale )
                DrawRect( x - 53.6625 * Scale, y - 0.5 * Scale, 26.325 * Scale, Scale )
                DrawRect( x - 0.5 * Scale, y + 27.3375 * Scale, Scale, 26.325 * Scale )
                DrawRect( x - 0.5 * Scale, y - 53.6625 * Scale, Scale, 26.325 * Scale )
                DrawRect( x - 0.5 * Scale, y + 67.8375 * Scale, Scale, 26.325 * Scale )
                DrawRect( x - 0.5 * Scale, y - 94.1625 * Scale, Scale, 26.325 * Scale )

                DrawRect( x + 27.3375 * Scale, y + 26.5 * Scale, 66.825 * Scale, Scale )
                DrawRect( x + 27.3375 * Scale, y - 27.5 * Scale, 66.825 * Scale, Scale )
                DrawRect( x - 94.1625 * Scale, y + 26.5 * Scale, 66.825 * Scale, Scale )
                DrawRect( x - 94.1625 * Scale, y - 27.5 * Scale, 66.825 * Scale, Scale )
                DrawRect( x + 108.3375 * Scale, y - 0.5 * Scale, 66.825 * Scale, Scale )
                DrawRect( x - 175.1625 * Scale, y - 0.5 * Scale, 66.825 * Scale, Scale )
            end
