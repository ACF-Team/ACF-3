...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Float", "SlewMax", { KeyName = "slewmax", Edit = { type = "Float", order = 24, category = "Camera Settings" , min = 0.001, max = 10, tooltip = "Camera rotation rate when zoomed out"  } } )
	...
	self:NetworkVar( "Entity", "Cam1Parent", { KeyName = "cam1parent", Edit = { type = "Entity", order = 33, category = "Camera Specific Settings", tooltip = "Parent for first camera (defaults to vehicle)" } } )
	self:NetworkVar( "Vector", "Cam2Offset", { KeyName = "cam2offset", Edit = { type = "Generic", order = 34, category = "Camera Specific Settings", tooltip = "Offset for second camera" } } )
	self:NetworkVar( "Int", "Cam2Orbit", { KeyName = "cam2orbit", Edit = { type = "Float", order = 35, category = "Camera Specific Settings" , min = 0, max = 400, tooltip = "Orbit distance for second camera" } } )
	self:NetworkVar( "Entity", "Cam2Parent", { KeyName = "cam2parent", Edit = { type = "Entity", order = 36, category = "Camera Specific Settings", tooltip = "Parent for second camera (defaults to vehicle)" } } )
	self:NetworkVar( "Vector", "Cam3Offset", { KeyName = "cam3offset", Edit = { type = "Generic", order = 37, category = "Camera Specific Settings", tooltip = "Offset for third camera" } } )
	self:NetworkVar( "Int", "Cam3Orbit", { KeyName = "cam3orbit", Edit = { type = "Float", order = 38, category = "Camera Specific Settings" , min = 0, max = 400, tooltip = "Orbit distance for third camera" } } )
	self:NetworkVar( "Entity", "Cam3Parent", { KeyName = "cam3parent", Edit = { type = "Entity", order = 39, category = "Camera Specific Settings", tooltip = "Parent for third camera (defaults to vehicle)" } } )
