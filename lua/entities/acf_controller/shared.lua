...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Bool", "DisableAmmoSelect", { KeyName = "disableammoselect", Edit = { type = "Bool", order = 13, category = "Miscellaneous" } } )
	self:NetworkVar( "Bool", "FlipAD", { KeyName = "flipad", Edit = { type = "Bool", order = 14, category = "Miscellaneous" } } )
	self:NetworkVar( "Bool", "ThrottleIgnoresAD", { KeyName = "throttleignoresad", Edit = { type = "Bool", order = 15, category = "Miscellaneous" } } )
	self:NetworkVar( "Bool", "ForceAWD", { KeyName = "forceawd", Edit = { type = "Bool", order = 16, category = "Miscellaneous" } } )
	self:NetworkVar( "Float", "ReloadAngle", { KeyName = "reloadangle", Edit = { type = "Float", order = 17, category = "Miscellaneous", min = -30, max = 30 } } )
	...
	self:NetworkVar( "Int", "DisableWeldBrake", { KeyName = "disableweldbrake", Edit = { type = "Bool", order = 72, category = "Brake Settings" } } )
	self:NetworkVar( "Int", "BrakeStrength", { KeyName = "brakestrength", Edit = { type = "Int", order = 73, category = "Brake Settings", min = 0.001, max = 1000 } } )
	self:NetworkVar( "Int", "BrakeStrengthTop", { KeyName = "brakestrengthtop", Edit = { type = "Int", order = 74, category = "Brake Settings", min = 0.001, max = 1000 } } )
	self:NetworkVar( "Int", "SpeedLow", { KeyName = "speedlow", Edit = { type = "Int", order = 75, category = "Brake Settings", min = 0.001, max = 1000 } } )
	self:NetworkVar( "Int", "SpeedTop", { KeyName = "speedtop", Edit = { type = "Int", order = 76, category = "Brake Settings", min = 0.001, max = 1000 } } )
