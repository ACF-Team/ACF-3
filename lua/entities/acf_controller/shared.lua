...
function ENT:SetupDataTables()
	...
	self:NetworkVar( "Bool", "DisableTurretLock", { KeyName = "disableturretlock", Edit = { type = "Bool", order = 506, category = "Weapon Settings", tooltip = "Disables the turret lock toggle, keeping turrets always active while in the seat instead of toggled with Reload" } } )
