...
do
	...
	function ACF.MakeCrew(Player, Pos, Angle, Data)
		...
		if not Entity.AlreadyHasSeat then
			...
			local Pod = ACF.GenerateLuaSeat(Entity, Player, Pos, Angle, CrewModel, true)
			if IsValid(Pod) then ConfigureLuaSeat(Entity, Pod) end
		else
...
do
	...
	function ENT:PostEntityPaste(Player, Ent, CreatedEntities)
		...
		if EntModes.LuaSeatID then
			local Pod = CreatedEntities[EntMods.LuaSeatID]
