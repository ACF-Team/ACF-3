...
--===============================================================================================--
do
	ACF.RegisterClassLink("acf_engine_update", "acf_fueltank", function(Engine, Target)
	...
	ACF.RegisterClassUnlink("acf_engine_update", "acf_fueltank", function(Engine, Target)
	...
	ACF.RegisterClassLink("acf_engine_update", "acf_gearbox_update", function(Engine, Target)
	...
	ACF.RegisterClassUnlink("acf_engine_update", "acf_gearbox_update", function(Engine, Target)
...
do -- Spawn and Update functions
	...
	local function VerifyData(Data)
		...
		do -- External verifications
			...
			HookRun("ACF_VerifyData", "acf_engine_update", Data, Class, Engine)
		end
	end
	...
	function MakeACF_Engine(Player, Pos, Angle, Data)
		...
		local CanSpawn = HookRun("ACF_PreEntitySpawn", "acf_engine_update", Player, Data, Class, Engine)

		if CanSpawn == false then return false end

		local Entity = ents.Create("acf_engine_update")
		...
		Player:AddCleanup("acf_engine_update", Entity)
		...
		HookRun("ACF_OnEntitySpawn", "acf_engine_update", Entity, Data, Class, Engine)
	...
	Entities.Register("acf_engine_update", MakeACF_Engine, "Engine")

	ACF.RegisterLinkSource("acf_engine_update", "FuelTanks")
	ACF.RegisterLinkSource("acf_engine_update", "Gearboxes")
	...
	function ENT:Update(Data)
		...
		local CanUpdate, Reason = HookRun("ACF_PreEntityUpdate", "acf_engine_update", self, Data, Class, Engine)
		...
		HookRun("ACF_OnEntityLast", "acf_engine_update", self, OldClass)
		...
		HookRun("ACF_OnEntityUpdate", "acf_engine_update", self, Data, Class, Engine)
...
ACF.AddInputAction("acf_engine_update", "Throttle", function(Entity, Value)
	Entity.Throttle = Clamp(Value, 0, 100) * 0.01
end)

ACF.AddInputAction("acf_engine_update", "Active", function(Entity, Value)
...
function ENT:CalcRPM(SelfTbl)
	...
	SelfTbl.FlyRPM = math.max(0, SelfTbl.FlyRPM)
...
function ENT:OnRemove()
	...
	HookRun("ACF_OnEntityLast", "acf_engine_update", self, Class)
