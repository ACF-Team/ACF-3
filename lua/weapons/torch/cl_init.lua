...
function SWEP:ViewModelDrawn()
	local Health = math.floor(self:GetNWFloat("HP", 0) * 10) / 10
	local MaxHealth = math.floor(self:GetNWFloat("MaxHP", 0) * 10) / 10
	local Armour = math.floor(self:GetNWFloat("Armour", 0) * 100) / 100
	local MaxArmour = math.floor(self:GetNWFloat("MaxArmour", 0) * 100) / 100
