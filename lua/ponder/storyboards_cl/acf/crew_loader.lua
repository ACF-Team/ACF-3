local Storyboard = Ponder.API.NewStoryboard("acf", "crew", "crew-loader")
Storyboard:WithMenuName("Loader Crew Guide")
Storyboard:WithPlaybackName("Crew - Loader Guide")
Storyboard:WithModelIcon("models/munitions/round_100mm.mdl")
Storyboard:WithDescription("Learn how to use loaders")
