...
Chapter3:AddInstruction("MoveCameraLookAt", {Length = 0, Distance = 2000})
-- Chapter3:AddInstruction("Delay", {Length = 1})

-- Import tank skeleton
local Hull = {
    {Name = "0", IdentifyAs = "0", Model = "models/sprops/cuboids/height06/size_1/cube_6x6x6.mdl", Angles = Angle(0, -90, 0), Position = Vector(0, 0, 0), ComeFrom = Vector(0, 0, 50), },
    {Name = "Base", IdentifyAs = "Baseplate", Model = "models/hunter/plates/plate2x5.mdl", Angles = Angle(0, 0, 0), Position = Vector(0, 0, 0), ComeFrom = Vector(0, 0, 50), ParentTo = "0", },
