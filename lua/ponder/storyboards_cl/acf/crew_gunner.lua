local Storyboard = Ponder.API.NewStoryboard("acf", "crew", "crew-gunner")
Storyboard:WithMenuName("Gunner Crew Guide")
Storyboard:WithPlaybackName("Crew - Gunner Guide")
Storyboard:WithModelIcon("models/acf/core/t_ring.mdl")
Storyboard:WithDescription("Learn how to use gunners")
