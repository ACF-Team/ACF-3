...
Chapter:AddInstruction("HideText", {Name = "Explain1"})
Chapter:AddInstruction("Delay", {Length = 2})
...
Chapter:AddDelay(Chapter:AddInstruction("Caption", {TextDatas = {{
...
Chapter:AddDelay(Chapter:AddInstruction("Caption", {
    Defaults = {
        Dimension = "3D",
        PositionRelativeToScreen = false,
    },
    TextDatas = {
        {
            Text = "Driver",
...
Chapter:AddInstruction("HideText", {Name = "Explain"}):DelayByLength()
