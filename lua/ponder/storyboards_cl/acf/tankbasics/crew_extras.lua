...
Chapter:AddInstruction("Delay", {Length = 8})
...
Chapter:AddInstruction("Delay", {Length = 4})
Chapter:AddInstruction("HideText", {Name = "Explain"})
...
Chapter:AddInstruction("MoveCameraLookAt", {Length = 2,  Angle = 45, Distance = 2000})
Chapter:AddInstruction("Delay", {Length = 2})
...
Chapter:AddInstruction("TransformModel", {Target = "Crew1", Position = Vector(0, 0, 0), Length = 2})

local Chapter = Storyboard:Chapter("Lean Efficiency")
Chapter:AddInstruction("Delay", {Length = 2})
Chapter:AddInstruction("MoveCameraLookAt", {Length = 2,  Angle = -90, Distance = 1500})
Chapter:AddInstruction("Delay", {Length = 2})
Chapter:AddInstruction("ShowText", {
    Name = "Explain",
    Dimension = "2D",
...
Chapter:AddInstruction("Delay", {Length = 2})
Chapter:AddInstruction("TransformModel", {Target = "Crew1", Position = Vector(0, 0, 24), Length = 2})
Chapter:AddInstruction("Delay", {Length = 2})
...
Chapter:AddInstruction("Delay", {Length = 2})
Chapter:AddInstruction("TransformModel", {Target = "Crew1", Rotation = Angle(0, 0, 22.5), Length = 1})
Chapter:AddInstruction("Delay", {Length = 1})
...
Chapter:AddInstruction("Delay", {Length = 1})
Chapter:AddInstruction("TransformModel", {Target = "Crew1", Rotation = Angle(0, 0, 45), Length = 1})
Chapter:AddInstruction("Delay", {Length = 1})
Chapter:AddInstruction("ChangeText", {
    Name = "Explain",
    Text = "Lean Eff: 0%",
...
Chapter:AddInstruction("Delay", {Length = 1})
Chapter:AddInstruction("TransformModel", {Target = "Crew1", Rotation = Angle(0, 0, 0), Length = 1})
Chapter:AddInstruction("Delay", {Length = 1})
Chapter:AddInstruction("ChangeText", {
    Name = "Explain",
    Text = "Lean Eff: 100%",
